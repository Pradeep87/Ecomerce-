import {LOGIN_REQUEST,LOGIN_SUCCESS,
    LOGIN_FAIL, CLEAR_ERROR,
  REGISTER_FAIL,REGISTER_REQUEST,REGISTER_SUCCESS, LOAD_USER_REQUEST, LOAD_USER_SUCCESS,
   LOAD_USER_FAIL,LOGOUT_FAIL,LOGOUT_SUCCESS,
   UPDATE_USER_PROFILE_FAIL,UPDATE_USER_PROFILE_REQUEST,UPDATE_USER_PROFILE_SUCCESS,
   UPDATE_USER_PASSWORD_FAIL,UPDATE_USER_PASSWORD_REQUEST,
...
export const update = (userData) => async (dispatch) => {
  try {
   ...
   userData,
    ...
    dispatch({ type: UPDATE_USER_PROFILE_FAIL, payload: error.response.data.message });
  }
};
